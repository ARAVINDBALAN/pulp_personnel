...
def create_db():
    ...
    #db.execute("create table if not exists sku_tab(sku varchar(8) primary key,blend_code varchar(20) not null ,sku_desc varchar(50),packet_size decimal ,case_size int,gross_wt decimal ,net_wt decimal ")
